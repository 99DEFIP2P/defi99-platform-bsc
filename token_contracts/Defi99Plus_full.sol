...
contract Defi99Plus {
    ...
    string public constant name = "99defi+";

    /// @notice EIP-20 token symbol for this token
    string public constant symbol = "99DEFI+";

    /// @notice EIP-20 token decimals for this token
    uint8 public constant decimals = 18;

    /// @notice Total number of tokens in circulation
    uint256 public constant totalSupply = 10000000e18; // 10 million 99defi+
    ...
    address public marketDistributionFund;  // Defi99Core address: distributed the tokens on the market's user
    ...
    /**
     * @notice Construct a new Defi99Plus token
     * @param account The initial Protocol account that hold the reserved tokens
     * @param marketDistributionFund_ The Defi99Core address that hold the market distribution tokens
    ...
    function _transferTokens(address src, address dst, uint256 amount) internal {
        require(src != address(0), "Defi99Plus::_transferTokens: cannot transfer from the zero address");
        require(dst != address(0), "Defi99Plus::_transferTokens: cannot transfer to the zero address");
